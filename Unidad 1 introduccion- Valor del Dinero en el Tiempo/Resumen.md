...
Informes que utilizan las instituciones para mostrar su **situación económica y financiera**, junto con los cambios que experimentan en una fecha o período determinado.

Su función principal es **facilitar la toma de decisiones** de los administradores y terceros que interactúan con la empresa.
...
## 2. Estado de Situación Patrimonial (ESP)
...
Expone, en forma **dinámica**, las entradas y salidas de efectivo de una empresa en un período determinado.

> **Efectivo** = dinero en caja y bancos + equivalentes de efectivo (inversiones que se vuelven efectivo en ≤ 90 días: plazos fijos cortos, letras, bonos cortos).

### Información que brinda

- Entradas y salidas de efectivo del período
- Habilidad de la empresa para generar flujos futuros
- Necesidades de efectivo y cómo cubrirlas
- Posibilidades de pagar dividendos o cumplir obligaciones
...
| Flujo neto del período | Entradas − Salidas (puede ser + o −) |
...
1. Comparar los dos ESP (inicio y fin del período) → identificar fuentes y usos
2. Analizar el Estado de Resultados → clasificar depreciaciones, utilidad neta y dividendos
3. Agrupar flujos en: Operativos / Inversión / Financiamiento
4. Calcular saldo final = Saldo inicial + Flujo operativo + Flujo de inversión + Flujo de financiamiento

---

## 4. Análisis Patrimonial y de Resultados
...
Descomposición:
ROA = Margen de Rentabilidad × Rotación
...
ROE = Margen × Rotación × Palanca Financiera
...
CI (por fuentes) = Activos Totales − Fuentes Espontáneas
```

- ROIC > 0 → inversión rentable
- ROIC < 0 → se perdió dinero
...
WACC = % Deuda × k_deuda + % Acc. × k_acc
```

- ROIC > WACC → empresa **crea valor** ✅
- ROIC < WACC → empresa **destruye valor** ❌ (aunque tenga ganancias)
